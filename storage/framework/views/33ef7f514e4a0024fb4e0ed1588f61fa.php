                    ...
                    <div class="user-avatar">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->foto_profil): ?>
                            <img src="<?php echo e(asset('storage/' . Auth::user()->foto_profil)); ?>" 
                                 alt="<?php echo e(Auth::user()->nama_user); ?>" 
                                 class="rounded-circle"
                                 style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->nama_user)); ?>&background=6366f1&color=fff&bold=true&size=128" 
                                 alt="<?php echo e(Auth::user()->nama_user); ?>" 
                                 class="rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow" aria-labelledby="userDropdown" style="min-width: 220px;">
                    ...
                    <div class="px-3 py-3 border-bottom bg-light">
                        <div class="d-flex align-items-center">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div>
                                <strong class="d-block text-truncate" style="max-width: 140px;"><?php echo e(Auth::user()->nama_user); ?></strong>
                                <small class="text-muted d-block text-truncate" style="max-width: 140px;"><?php echo e(Auth::user()->email); ?></small>
                            </div>
                        </div>
                    </div>
                    
                    
                    <a class="dropdown-item py-2" href="<?php echo e(route('profil')); ?>">
...
<?php /**PATH D:\Belajar\laragon\www\iscp\Projek_Perpus\resources\views/components/layouts/navigasi.blade.php ENDPATH**/ ?>