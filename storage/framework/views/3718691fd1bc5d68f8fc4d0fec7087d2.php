    ...
    <div class="history-card-modern">
                ...
                <div>
                    ...
                    <small style="color: rgba(255,255,255,0.9); font-size: 14px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeCount > 0): ?>
                            <span style="color: #fef3c7; font-weight: 600;"> • <?php echo e($activeCount); ?> masih dipinjam</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </small>
                </div>
        ...
        <div style="padding: 28px;">
            ...
            <div class="list-group" style="border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
                ...
                ?>
                <div class="list-group-item" style="border: none; border-bottom: 1px solid #f3f4f6; padding: 20px 24px; transition: all 0.2s; <?php echo e($terlambat ? 'background: #fef2f2;' : ''); ?>" onmouseover="this.style.background='<?php echo e($terlambat ? '#fee2e2' : '#f9fafb'); ?>';" onmouseout="this.style.background='<?php echo e($terlambat ? '#fef2f2' : 'white'); ?>';">
                    <div class="row align-items-center">
                        
                        <div class="col-md-4">
                            <div style="display: flex; align-items: center; gap: 14px;">
                                <div style="background: linear-gradient(135deg, <?php echo e($is_aktif ? ($terlambat ? '#ef4444 0%, #dc2626' : '#f59e0b 0%, #d97706') : '#10b981 0%, #059669'); ?> 100%); width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 3px 8px rgba(<?php echo e($is_aktif ? ($terlambat ? '239, 68, 68' : '245, 158, 11') : '16, 185, 129'); ?>, 0.25);">
                                    <i data-feather="<?php echo e($is_aktif ? 'book-open' : 'check-circle'); ?>" style="width: 24px; height: 24px; color: white;"></i>
                                </div>
                                <div style="flex: 1; min-width: 0;">
                                    <div style="font-weight: 700; color: <?php echo e($terlambat ? '#dc2626' : '#111827'); ?>; font-size: 14px; margin-bottom: 4px;"><?php echo e($data->kode_transaksi); ?></div>
                        ...
                        <div class="col-md-3">
                            <div style="font-size: 13px; color: #6b7280; line-height: 1.8;">
                                ...
                                <div style="margin-bottom: 4px; <?php echo e($terlambat ? 'color: #dc2626; font-weight: 700;' : ''); ?>">
                                    <i data-feather="clock" style="width: 13px; height: 13px;"></i> 
                                    <strong style="<?php echo e($terlambat ? 'color: #dc2626;' : 'color: #374151;'); ?>">Tempo:</strong> <?php echo e(\Carbon\Carbon::parse($data->tgl_jatuh_tempo)->format('d/m/Y')); ?>
                                ...
                                <div style="color: #dc2626; font-weight: 700; font-size: 12px;">
                                    <i data-feather="alert-triangle" style="width: 13px; height: 13px;"></i> Terlambat <?php echo e($hari_terlambat); ?> hari
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="col-md-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($is_aktif): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($terlambat): ?>
                            ...
                            <?php else: ?>
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->denda_total > 0): ?>
                                    <div style="color: #dc2626; font-size: 12px; font-weight: 700; margin-top: 6px;">
                                        Denda: Rp <?php echo e(number_format($data->denda_total, 0, ',', '.')); ?>
                        ...
                        <div class="col-md-2 text-right">
                            <div style="display: flex; align-items: center; justify-content: flex-end; gap: 8px;" x-data x-init="$nextTick(() => feather.replace())">
                                <button wire:click="cetakStruk(<?php echo e($data->id_peminjaman); ?>)" class="history-btn-detail" title="Cetak Struk">
                                    <i data-feather="printer" style="width: 15px; height: 15px;"></i>
                                </button>
                                <button wire:click="viewDetail(<?php echo e($data->id_peminjaman); ?>)" class="history-btn-detail" title="Lihat Detail">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPustakawan): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->status_buku === 'kembali'): ?>
                                        <button onclick="confirm('Yakin hapus peminjaman <?php echo e($data->kode_transaksi); ?>?') || event.stopImmediatePropagation()"
                                            wire:click="destroy(<?php echo e($data->id_peminjaman); ?>)"
                    ...
                    <div style="background: #dbeafe; padding: 20px; border-radius: 12px; margin-bottom: 20px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div style="font-weight: 700; color: #111827; font-size: 13px;"><?php echo e(\Carbon\Carbon::parse($detailPeminjaman->tgl_jatuh_tempo)->format('d M Y')); ?></div>
                            </div>
                            <div class="col-md-4 mb-2">
                        ...
                        <div style="margin-top: 14px;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detailPeminjaman->status_buku === 'dipinjam'): ?>
                            ...
                            <?php else: ?>
                                ...
                                <div style="color: #dc2626; font-size: 13px; font-weight: 700; margin-top: 8px;">
                                    Total Denda: Rp <?php echo e(number_format($detailPeminjaman->denda_total, 0, ',', '.')); ?>
                            ...
                            <table class="table mb-0" style="font-size: 13px;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-bottom: 1px solid #f3f4f6;">
                                        <td style="padding: 12px; color: #6b7280; font-family: monospace; font-size: 12px;"><?php echo e($detail->eksemplar->kode_eksemplar); ?></td>
                                        <td style="padding: 12px; color: #374151; font-weight: 600;"><?php echo e($detail->eksemplar->buku->judul); ?></td>
                                        <td style="padding: 12px; text-align: center;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detail->eksemplar->status_eksemplar === 'dipinjam'): ?>
                    ...
                    <table style="width: 100%; font-size: 13px;">
                        ...
                        <tr>
                            ...
                            <td style="padding: 6px 0;">: 
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastPeminjaman->status_buku === 'dipinjam'): ?>
    ...
    <div x-show="showExportModal" 
        ...
        <div x-show="showExportModal"
            ...
            <div style="padding: 24px;">
                ...
                <form id="exportForm" method="GET" action="<?php echo e(route('history-peminjaman.export')); ?>">
                    
                    <input type="hidden" name="search" value="<?php echo e($search); ?>">
                    <input type="hidden" name="filterStatus" value="<?php echo e($filterStatus); ?>">
...
<?php /**PATH D:\Belajar\laragon\www\iscp\Projek_Perpus\resources\views/livewire/history-peminjaman-modern.blade.php ENDPATH**/ ?>