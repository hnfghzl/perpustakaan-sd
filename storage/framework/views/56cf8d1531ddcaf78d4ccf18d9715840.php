            ...
            <div class="row mb-4">
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #3b82f6;"><?php echo e($laporanPeminjaman['totalPeminjaman'] ?? 0); ?></div>
                ...
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #ef4444;"><?php echo e($laporanPeminjaman['peminjamanTerlambat'] ?? 0); ?></div>
                        <p style="color: #9ca3af; font-size: 12px; margin: 0;"><?php echo e($laporanPeminjaman['persenTerlambat'] ?? 0); ?>% dari total</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #10b981;"><?php echo e(100 - ($laporanPeminjaman['persenTerlambat'] ?? 0)); ?>%</div>
            ...
            <div class="report-card">
                ...
                <div class="table-responsive">
                    <table class="table table-hover" style="margin-bottom: 0;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($statistikAnggota['topAnggota'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $peminjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr style="border-bottom: 1px solid #f3f4f6;">
                                ...
                                <td style="padding: 12px; font-weight: 600; color: #111827;"><?php echo e($peminjam['nama'] ?? 'N/A'); ?></td>
                                <td style="padding: 12px;">
                                    <span style="display: inline-block; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600;
                                        <?php echo e(($peminjam['jenis'] ?? '') === 'guru' ? 'background: #dbeafe; color: #3b82f6;' : 'background: #d1fae5; color: #10b981;'); ?>">
                                        <?php echo e(ucfirst($peminjam['jenis'] ?? 'N/A')); ?>
                                ...
                                <td style="padding: 12px;">
                                    <span style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 20px; background: #f3f4f6; color: #374151; font-weight: 600; font-size: 13px;">
                                        ...
                                        <?php echo e($peminjam['total_pinjam'] ?? 0); ?> kali
                                    </span>
                                </td>
                            </tr>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #3b82f6;"><?php echo e($statistikAnggota['totalAnggota'] ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #f59e0b;"><?php echo e($statistikAnggota['totalGuru'] ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #10b981;"><?php echo e($statistikAnggota['totalSiswa'] ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #ec4899;"><?php echo e($statistikAnggota['anggotaAktif'] ?? 0); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #3b82f6;"><?php echo e($inventarisKoleksi['totalJudulBuku'] ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #10b981;"><?php echo e($inventarisKoleksi['totalEksemplar'] ?? 0); ?></div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-value" style="color: #f59e0b;"><?php echo e($inventarisKoleksi['totalKategori'] ?? 0); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="report-card">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = ($laporanPeminjaman['bukuTerpopuler'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $buku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr style="border-bottom: 1px solid #f3f4f6;">
                                <td style="padding: 12px;">
                                    <span style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 50%; font-weight: 700; font-size: 14px;
                                        <?php echo e($index < 3 ? 'background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); color: #f59e0b;' : 
                                           'background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); color: #3b82f6;'); ?>">
                                        <?php echo e($index + 1); ?>

                                    </span>
                                </td>
                                <td style="padding: 12px; font-weight: 600; color: #111827;"><?php echo e($buku['judul'] ?? 'N/A'); ?></td>
                                <td style="padding: 12px; color: #6b7280;"><?php echo e($buku['pengarang'] ?? 'N/A'); ?></td>
                                <td style="padding: 12px;">
                                ...
                                <td style="padding: 12px;">
                                    <span style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 20px; background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%); color: #3b82f6; font-weight: 600; font-size: 13px;">
                                        ...
                                        <?php echo e($buku['total_pinjam'] ?? 0); ?>x
                                    </span>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
function initLaporanCharts() {
    ...
    if (trenCtx) {
        const trenData = <?php echo json_encode($laporanPeminjaman['trenPeminjaman'] ?? [], 15, 512) ?>;
    ...
    if (anggotaCtx) {
        new Chart(anggotaCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($statistikAnggota['totalGuru'] ?? 0); ?>,
                        <?php echo e($statistikAnggota['totalSiswa'] ?? 0); ?>
    ...
    if (statusCtx) {
        const statusData = <?php echo json_encode($inventarisKoleksi['distribusiStatus'] ?? [], 15, 512) ?>;
...
<?php /**PATH D:\Belajar\laragon\www\iscp\Projek_Perpus\resources\views/livewire/laporan-modern.blade.php ENDPATH**/ ?>