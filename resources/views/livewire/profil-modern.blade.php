        ...
        <div class="col-md-4">
            ...
            <div class="profil-card" style="margin-bottom: 24px;">
                <div style="padding: 32px 24px; text-align: center;">
                    ...
                    {{-- Name & Role --}}
                    <h5 style="color: #374151; font-weight: 700; margin-bottom: 8px; font-size: 20px;">{{ $user->nama_user }}</h5>
                    <div style="margin-bottom: 16px;">
                        ...
                        @else
                            <span class="profil-badge" style="background: #6b7280; color: white;">{{ ucfirst($user->role) }}</span>
                        @endif
                    </div>
                ...
                <div style="padding: 28px;">
                    <form wire:submit.prevent="updateProfil">
                        ...
                        <div style="margin-bottom: 24px;">
                            ...
                            @error('foto_profil')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            @error('nama_user')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                        </div>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            @error('email')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                        </div>
                        ...
                        <div style="margin-bottom: 24px;">
                            ...
                            <input type="text" value="{{ $role === 'pustakawan' ? 'Pustakawan' : 'Kepala Sekolah' }}" disabled style="width: 100%; padding: 12px 16px; border: 2px solid #e5e7eb; border-radius: 10px; font-size: 14px; background: #f9fafb; color: #6b7280;">
                    ...
                    @else
                        <form wire:submit.prevent="updatePassword">
                            <div style="margin-bottom: 20px;">
                                ...
                                @error('current_password')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                            </div>
                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                @error('new_password')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                            </div>
                            ...
                            <div style="margin-bottom: 24px;">
                                ...
                                @error('new_password_confirmation')<small style="color: #ef4444; font-size: 12px; margin-top: 6px; display: block;">{{ $message }}</small>@enderror
                            </div>
