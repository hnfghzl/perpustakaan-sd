...
<div style="background: transparent;">
                        ...
                        <td style="padding: 16px; vertical-align: middle; text-align: center;">
                            <div class="d-flex justify-content-center gap-2" style="gap: 8px;">
                                <button wire:click="edit({{ $data->id_user }})" 
                                    type="button"
                                    class="btn btn-sm" 
                                    style="background: #f3f4f6; color: #374151; border: none; border-radius: 8px; padding: 8px 12px; font-weight: 500; transition: all 0.2s; cursor: pointer;"
                                ...
                                @if($canDelete)
                                <button wire:click="deleteNow({{ $data->id_user }})" 
                                    wire:confirm="⚠️ Yakin ingin menghapus user '{{ $data->nama_user }}'?\n\nData yang dihapus tidak dapat dikembalikan!"
                                    type="button"
                                    class="btn btn-sm" 
                                    style="background: #f3f4f6; color: #374151; border: none; border-radius: 8px; padding: 8px 12px; font-weight: 500; transition: all 0.2s; cursor: pointer;"
    ...
    <div style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.6); z-index: 9999; display: flex; align-items: center; justify-content: center;" 
        ...
        <div style="background: white; border-radius: 16px; max-width: 480px; width: 90%; max-height: 90vh; overflow-y: auto; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);"
             wire:click.stop>
            ...
            <div style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); padding: 24px; border-radius: 16px 16px 0 0; display: flex; justify-content: space-between; align-items: center;">
                ...
                <button type="button" wire:click="closeForm" style="background: rgba(255,255,255,0.2); border: none; color: white; width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
            ...
            <div style="padding: 32px;">
                <form wire:submit.prevent="{{ $updateData ? 'update' : 'store' }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select wire:model="role" class="form-control" style="border-radius: 10px; border: 2px solid #e5e7eb; padding: 12px 16px; font-size: 14px; height: auto !important; line-height: 1.5 !important; min-height: 48px;">
                    ...
                    <div class="d-flex gap-2 mt-4 pt-3" style="gap: 12px; border-top: 1px solid #e5e7eb;">
                        ...
                        <button type="button" wire:click="closeForm" class="btn btn-modern" style="background: #f3f4f6; color: #6b7280; padding: 12px 24px; font-size: 15px;">
