{{-- Dashboard Modern untuk Role Kepala Sekolah --}}
<style>
    .metric-card {
        background: white;
        border-radius: 16px;
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card">
                ...
                <div class="metric-value" style="color: #3b82f6;">{{ number_format($totalAnggota) }}</div>
                <div class="metric-sublabel">Guru: {{ $totalGuru ?? 0 }} | Siswa: {{ $totalSiswa ?? 0 }}</div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card">
                ...
                <div class="metric-value" style="color: #10b981;">{{ number_format($totalBuku) }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card">
                ...
                <div class="metric-value" style="color: #f59e0b;">{{ number_format($peminjamanAktif) }}</div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="metric-card">
                ...
                <div class="metric-value" style="color: #ef4444;">{{ number_format($bukuTerlambat) }}</div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="metric-card">
                ...
                <div class="metric-sublabel">{{ $jumlahTransaksiBelumDibayar ?? 0 }} transaksi belum lunas</div>
            </div>
        </div>
            ...
            <table class="table table-hover" style="margin-bottom: 0;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #f3f4f6;">
                        ...
                        <td style="padding: 16px; vertical-align: middle;">
                            <span style="font-weight: 600; color: #111827; font-size: 14px;">{{ $kategori->nama }}</span>
                        </td>
                        <td style="padding: 16px; vertical-align: middle;">
                            ...
                            <div style="display: flex; align-items: center; gap: 12px;">
                                ...
                                <div class="progress-bar-custom">
                                    <div class="progress-fill" style="
                                        width: {{ $percentage }}%; 
                                        background: {{ $index === 0 ? 'linear-gradient(90deg, #f59e0b 0%, #d97706 100%)' : 
...
function initCharts() {
    ...
    if (statusCtx) {
        ...
        console.log('Tersedia:', {{ $eksemplarTersedia }});
        console.log('Dipinjam:', {{ $eksemplarDipinjam }});
        console.log('Rusak:', {{ $eksemplarRusak }});
        console.log('Hilang:', {{ $eksemplarHilang }});
