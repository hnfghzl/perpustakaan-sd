    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #111827;">{{ $totalAnggota ?? 0 }}</div>
                <a href="{{ route('anggota') }}" class="stat-link">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #111827;">{{ $totalBuku ?? 0 }}</div>
                <a href="{{ route('buku') }}" class="stat-link">
                    Lihat Detail <i data-feather="arrow-right" style="width: 14px; height: 14px;"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #3b82f6;">{{ $peminjamanAktif ?? 0 }}</div>
                <a href="{{ route('peminjaman') }}" class="stat-link">
                    Lihat Detail <i data-feather="arrow-right" style="width: 14px; height: 14px;"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #ef4444;">{{ $bukuTerlambat ?? 0 }}</div>
                <a href="{{ route('peminjaman') }}" class="stat-link">
                    Lihat Detail <i data-feather="arrow-right" style="width: 14px; height: 14px;"></i>
                </a>
            </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #f59e0b; font-size: 28px;">Rp {{ number_format($totalDendaBelumDibayar ?? 0, 0, ',', '.') }}</div>
                <div style="color: #6b7280; font-size: 13px; margin-top: 8px;">
                    <i data-feather="file-text" style="width: 12px; height: 12px;"></i>
                    {{ $jumlahTransaksiBelumDibayar ?? 0 }} transaksi
                </div>
                <a href="{{ route('peminjaman') }}" class="stat-link" style="margin-top: 8px;">
                    Lihat Detail <i data-feather="arrow-right" style="width: 14px; height: 14px;"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #10b981; font-size: 28px;">Rp {{ number_format($totalDendaSudahDibayar ?? 0, 0, ',', '.') }}</div>
                <div style="color: #6b7280; font-size: 13px; margin-top: 8px;">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="stat-card-modern">
                ...
                <div class="stat-number" style="color: #6366f1; font-size: 28px;">Rp {{ number_format(($totalDendaBelumDibayar ?? 0) + ($totalDendaSudahDibayar ?? 0), 0, ',', '.') }}</div>
                <div style="color: #6b7280; font-size: 13px; margin-top: 8px;">
    ...
    <div class="stat-card-modern mb-4">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-3">
                <a href="{{ route('peminjaman') }}" class="btn btn-block" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; border: none; border-radius: 12px; padding: 16px; font-weight: 600; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s;">
                    <i data-feather="plus-circle" style="width: 20px; height: 20px;"></i>
                    Peminjaman Baru
                </a>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <a href="{{ route('peminjaman') }}" class="btn btn-block" style="background: #f3f4f6; color: #374151; border: none; border-radius: 12px; padding: 16px; font-weight: 600; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s;">
                    <i data-feather="rotate-ccw" style="width: 20px; height: 20px;"></i>
                    Pengembalian Buku
                </a>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <a href="{{ route('anggota') }}" class="btn btn-block" style="background: #f3f4f6; color: #374151; border: none; border-radius: 12px; padding: 16px; font-weight: 600; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s;">
                    <i data-feather="user-plus" style="width: 20px; height: 20px;"></i>
                    Tambah Anggota
                </a>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <a href="{{ route('buku') }}" class="btn btn-block" style="background: #f3f4f6; color: #374151; border: none; border-radius: 12px; padding: 16px; font-weight: 600; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.3s;">
